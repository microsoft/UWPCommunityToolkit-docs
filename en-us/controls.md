...
| [SlideableListItem Overview]({{site.baseurl}}/{{page.lang}}/controls/SlideableListItem.htm) | [SlidableListItem]({{site.baseurl}}/{{page.lang}}/api/Microsoft_Toolkit_Uwp_UI_Controls_SlidableListItem.htm) | ContentControl providing functionality for sliding left or right to expose functions |
