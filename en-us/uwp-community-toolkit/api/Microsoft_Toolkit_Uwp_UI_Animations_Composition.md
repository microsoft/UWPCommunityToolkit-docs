...
| delay | The delay. (ignored if duration == 0) | System.Double |
...
| duration | The duration. | System.Double |
| delay | The delay in milliseconds. (ignored if duration == 0) | System.Double |
...
| duration | The duration. | System.Double |
| delay | The delay. (ignored if duration == 0) | System.Double |
| value | The blur amount. | System.Double |
| return |The Composition Effect Brush of the blur so you can control animations manually. |
